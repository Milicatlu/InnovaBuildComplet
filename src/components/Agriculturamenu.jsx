...
export function Agriculturamenu(props) {
   ...
   const handleButtonPress = () => {
      Alert.alert(
         'Editar Nombre', 'Ingrese el nuevo nombre:',
         [
            {
               text: 'Cancel',
            },
            {
               text: 'Aceptar',
               onPress: () => Alert.alert('Se cambio el nombre exitosamente'),
               style: 'cancel',
            },
         ],
   ...
   let prompt = () => {
      Alert.alert(
         'Editar nombre:', 'Ingrese nuevo nombre',
         (name) => console.log(name)
      )
   };

   const handleEditarNombreBolsa = (grupoIndex, bolsaIndex) => {
      const nombreBolsaSeleccionada = grupos[grupoIndex][bolsaIndex];
      setNombreBolsa(nombreBolsaSeleccionada);
   };
   ...
   const renderSiloBolsa = () => {
      ...
      return grupos.map((grupo, index) => (
         <View key={index} style={styles.SiloContainer}>
            {grupo.map((siloBolsa) => (
               <StyledButtonAgri style={{ color: "#FFF" }} key={siloBolsa} styleContainer={styles.vacio} onPress={() => {
                  props.navigation.navigate("SiloMenu");
                  () => handleEditarNombreBolsa(grupoIndex, bolsaIndex)
               }}>
         ...
         <View style={styles.container} {...props}>
            ...
            >
               ...
               <View style={styles.subcontainer}>
                  ...
                  <StyledText align="center" fontSize="subheading1" fontWeight="bold"> Silo bolsas</StyledText>
                  ...
                  <View>
                     ...
                     <View style={{ marginTop: 15 }}>
                        <MaterialIcons name="create" size={18} style={styles.icono} >
                           <StyledText style={styles.texto} onPress={handleButtonPress}> Editar nombre de Bolsa</StyledText>
